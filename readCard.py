...
#img =cv2.imread('twoCards.png')
#img =cv2.imread('glass_example.png')
#img =cv2.imread('card_example.png')
#img =cv2.imread('training_cards.png')
#img =cv2.imread('glass_training_deck.png')
...
def find_closet_card(training, img):
    features = preporcess(img)
...
def get_training(training_labels_filename, training_image_filenem, num_trainingcards, avid_cards = None):
    training = {}
